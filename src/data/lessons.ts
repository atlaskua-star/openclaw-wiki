...
`
  },
  {
    ...
    content: [
      ...
      '---',
      '',
      '## 4.11 Hands On: WhatsApp Groups',
      '',
      "Once your WhatsApp channel is linked, here's how to make the bot talk in WhatsApp groups:",
      '',
      ...
      '  groupPolicy: "allowlist",   // blocks groups by default',
      '}',
      '```',
      '',
      '### Step 2 \u2014 Allow Group Messages',
      '',
      'There are two controls for groups:',
      '',
      '**Group admission** \u2014 which groups the bot listens to:',
      '',
      '```bash',
      '# Allow all groups',
      `openclaw config set channels.whatsapp.groups '{"*": {}}'`,
      '',
      '# Or restrict to specific groups (find JID from logs)',
      `openclaw config set channels.whatsapp.groups '{"120363424282127706@g.us": {}}'`,
      '```',
      '',
      '**Sender policy** \u2014 who can trigger a reply in groups:',
      '',
      '```bash',
      '# Option A: Anyone in the group can trigger',
      'openclaw config set channels.whatsapp.groupPolicy open',
      '',
      '# Option B: Only you (keep allowlist, your number is already in allowFrom)',
      'openclaw config set channels.whatsapp.groupPolicy allowlist',
      '```',
      '',
      '### Step 3 \u2014 Respond to Messages',
      '',
      "By default, the bot only responds when **@mentioned** in a group:",
      '',
      '```',
      '@MyBot what\'s the weather today?',
      '```',
      '',
      'To change this behaviour per-chat:',
      '',
      '- `/activation always` \u2014 respond to every message in this group',
      '- `/activation mention` \u2014 respond only when mentioned (default)',
      '',
      '### Step 4 \u2014 Disable Groups',
      '',
      'To turn off group access entirely:',
      '',
      '```bash',
      'openclaw config set channels.whatsapp.groupPolicy disabled',
      '```',
      '',
      'The bot will still reply to direct messages \u2014 only group messages are blocked.',
      '',
      '---',
      '',
